...
public class Diary extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.diaryId, rhs.diaryId)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.diaryId)
				.append(this.dayTime).append(this.content)
				.append(this.diaryType).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("diaryId", this.diaryId)
				...
				.append("diaryType", this.diaryType).toString();
	}
