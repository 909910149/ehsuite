...
public class ReportParam extends BaseModel {
	...
	public Long getReportId() {
		return getReportTemplate() == null ? null : getReportTemplate()
				.getReportId();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.paramId)
				.append(this.paramName).append(this.paramKey)
				.append(this.defaultVal).append(this.paramType).append(this.sn)
				.toHashCode();
	}
