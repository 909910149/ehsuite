...
/*     */ 
/*  38 */   public List<InMessage> getInList() { return this.inList; }
/*     */ 
...
/*  83 */     List list = this.shortMessageService.searchShortMessage(appUser.getUserId(), this.shortMessage, this.from, this.to, pb, null);
/*  84 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':" + pb.getTotalItems() + ",result:");
/*  85 */     List inList = new ArrayList();
...
/* 107 */     if ((StringUtils.isNotEmpty(reId)) && (StringUtils.isNotEmpty(content))) {
...
/* 119 */         AppUser user = (AppUser)this.appUserService.get(Long.valueOf(Long.parseLong(st[i])));
