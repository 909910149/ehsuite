...
/*  68 */     SimpleDateFormat simpleDate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
/*  69 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
/*  70 */       .append(filter.getPagingBean().getTotalItems()).append(",result:[");
/*  71 */     for (NewsComment newsComment : list) {
/*  72 */       buff.append("{commentId:'")
/*  73 */         .append(newsComment.getCommentId())
/*  74 */         .append("',subject:").append(gson.toJson(newsComment.getNews().getSubject()))
/*  75 */         .append(",content:")
/*  76 */         .append(gson.toJson(newsComment.getContent()))
/*  77 */         .append(",createtime:'")
/*  78 */         .append(simpleDate.format(newsComment.getCreatetime()))
/*  79 */         .append("',fullname:'")
...
/* 103 */         NewsComment delComment = (NewsComment)this.newsCommentService.get(new Long(id));
/* 104 */         News news = delComment.getNews();
/* 105 */         if (news.getReplyCounts().intValue() > 1) {
/* 106 */           news.setReplyCounts(Integer.valueOf(news.getReplyCounts().intValue() - 1));
/*     */         }
...
/*     */   public String get()
/*     */   {
/* 123 */     NewsComment newsComment = (NewsComment)this.newsCommentService.get(this.commentId);
/*     */ 
...
/*     */   public String save()
/*     */   {
/* 139 */     News news = (News)this.newsService.get(this.newsComment.getNewsId());
/* 140 */     news.setReplyCounts(Integer.valueOf(news.getReplyCounts().intValue() + 1));
/* 141 */     this.newsService.save(news);
/*     */ 
/* 143 */     this.newsComment.setAppUser((AppUser)this.appUserService.get(this.newsComment.getUserId()));
