...
/*     */ 
/*  83 */     List list = this.inMessageService.searchInMessage(appUser.getUserId(), this.inMessage, this.shortMessage, this.from, this.to, pb);
/*     */ 
/*  87 */     List inList = new ArrayList();
/*  88 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':" + pb.getTotalItems() + ",result:");
...
/*     */     }
/* 111 */     InMessage in = (InMessage)this.inMessageService.get(receiveId);
...
/* 126 */         this.inMessage = ((InMessage)this.inMessageService.get(Long.valueOf(Long.parseLong(id))));
...
/* 143 */       this.inMessage = ((InMessage)this.inMessageService.get(replyId));
/* 144 */       StringBuffer buff = new StringBuffer("{success:true,data:[");
/* 145 */       buff.append("{'messageId':" + this.inMessage.getShortMessage().getMessageId() + ",'senderId':'" + this.inMessage.getShortMessage().getSenderId() + "','sender':'" + this.inMessage.getShortMessage().getSender() + "'}").append("]}");
...
/* 163 */         flag = true;
/* 164 */         this.inMessage = this.inMessageService.findLatest(userId);
/*     */       }
...
/* 171 */         String date = sdf.format(this.shortMessage.getSendTime());
/* 172 */         StringBuffer buff = new StringBuffer("{success:true,message:");
/* 173 */         buff.append("{'receiveId':" + this.inMessage.getReceiveId() + ",'messageId':" + this.shortMessage.getMessageId() + ",'senderId':" + this.shortMessage.getSenderId() + ",'sender':'" + this.shortMessage.getSender() + "','content':'" + this.shortMessage.getContent().replace("\n", " ") + "','sendTime':'" + date + "','msgType':" + this.shortMessage.getMsgType());
/* 174 */         if (!flag) {
/* 175 */           InMessage in = this.inMessageService.findByRead(userId);
/* 176 */           if (in != null)
...
/*     */ 
/*     */   public String count() {
/* 196 */     Integer in = this.inMessageService.findByReadFlag(ContextUtil.getCurrentUser().getUserId());
...
/* 210 */       this.inMessage = ((InMessage)this.inMessageService.get(receiveId));
...
/* 224 */     List list = this.shortMessageService.searchShortMessage(appUser.getUserId(), null, null, null, pb, InMessage.FLAG_UNREAD);
/* 225 */     List inList = new ArrayList();
/* 226 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':" + pb.getTotalItems() + ",result:");
...
/* 240 */         this.inMessage = ((InMessage)this.inMessageService.get(Long.valueOf(Long.parseLong(id))));
