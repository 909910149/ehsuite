 ...
 public class BookBorRetAction extends BaseAction
 {
   ...
   public String list()
   {
     ...
     JSONSerializer serializer = JsonUtil.getJSONSerializer(new String[] { "borrowTime", "returnTime", "lastReturnTime" });
   ...
   public String getBorRetTime()
   {
     ...
     JSONSerializer serializer = JsonUtil.getJSONSerializer(new String[] { "borrowTime", "returnTime" });
     StringBuffer sb = new StringBuffer("{success:true,data:");
     sb.append(serializer.exclude(new String[] { "class" }).serialize(bookBorRet));
     sb.append("}");
     setJsonString(sb.toString());
