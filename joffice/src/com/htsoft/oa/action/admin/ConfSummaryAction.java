 ...
 public class ConfSummaryAction extends BaseAction
 {
   ...
   public String list()
   {
     ...
     List list = this.confSummaryService.getAll(filter);
   ...
   public String get()
   {
     ConfSummary confSummary = (ConfSummary)this.confSummaryService.get(this.sumId);
     Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss")
       .create();
   ...
   public String send()
   {
     ...
     if ((content == null) || (content.isEmpty()) || (content.equals(" "))) {
       ...
       this.confSummary.setStatus(Short.valueOf((short) 1));
   ...
   public String save()
   {
     ...
     if ((content == null) || (content.isEmpty()) || (content.equals(" "))) {
       ...
       this.confSummary.setCreatetime(new Date());
       this.confSummary.setCreator(ContextUtil.getCurrentUser().getUsername());
       this.confSummary.setStatus(Short.valueOf((short) 0));
   ...
   public String display()
   {
     ...
     for (int i = 0; i < list.size(); i++) {
       ConfSummary cm = (ConfSummary)list.get(i);
