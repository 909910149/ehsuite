...
/*     */ 
/*  52 */   public String getDeleteItemIds() { return this.deleteItemIds; }
/*     */ 
...
/*  89 */     List list = this.standSalaryService.getAll(filter);
/*     */ 
/*  91 */     Type type = new TypeToken() {  }
/*  91 */     .getType();
/*  92 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
/*  93 */       .append(filter.getPagingBean().getTotalItems()).append(",result:");
/*     */ 
/*  95 */     Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
...
/*     */   public String get()
/*     */   {
/* 126 */     StandSalary standSalary = (StandSalary)this.standSalaryService.get(this.standardId);
/*     */ 
/* 128 */     Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
/*     */ 
...
/*     */   {
/* 143 */     StandSalary standSalary = (StandSalary)this.standSalaryService.get(this.standardId);
/*     */ 
/* 145 */     Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
/*     */ 
...
/* 164 */       if (this.standSalaryService.checkStandNo(this.standSalary.getStandardNo()))
/* 165 */         pass = true;
/*     */       else
...
/*     */       {
/* 176 */         this.standSalary.setModifyName(ContextUtil.getCurrentUser().getFullname());
/* 177 */         this.standSalary.setModifyTime(new Date());
/*     */       } else {
/* 179 */         this.standSalary.setSetdownTime(new Date());
/* 180 */         this.standSalary.setFramer(ContextUtil.getCurrentUser().getFullname());
/*     */       }
...
/* 187 */             this.standSalaryItemService.remove(new Long(id));
/*     */           }
/*     */         }
/*     */       }
...
/* 194 */         StandSalaryItem[] standSalaryItems = (StandSalaryItem[])gson.fromJson(this.data, com.htsoft.oa.model.hrm.StandSalaryItem[].class);
...
/*     */           }
/* 199 */           standSalaryItem.setStandardId(this.standSalary.getStandardId());
...
/* 213 */     StandSalary checkStandard = (StandSalary)this.standSalaryService.get(this.standSalary.getStandardId());
/* 214 */     checkStandard.setCheckName(ContextUtil.getCurrentUser().getFullname());
/* 215 */     checkStandard.setCheckTime(new Date());
/* 216 */     checkStandard.setCheckOpinion(this.standSalary.getCheckOpinion());
/* 217 */     if ((StringUtils.isNotEmpty(status)) && (Short.valueOf(status).shortValue() == STATUS_PASS))
...
/*     */   {
/* 232 */     SimpleDateFormat date = new SimpleDateFormat("yyyyMMddHHmmss-SSSS");
...
/*     */   public String combo()
/*     */   {
/* 242 */     List list = this.standSalaryService.findByPassCheck();
/* 243 */     Type type = new TypeToken() {  }
/* 243 */     .getType();
/* 244 */     StringBuffer buff = new StringBuffer();
/* 245 */     Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
