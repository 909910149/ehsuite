...
/*  58 */       sb.append("['").append(planType.getTypeId()).append("','").append(planType.getTypeName()).append("'],");
/*     */     }
...
/*  74 */     List list = this.planTypeService.getAll(filter);
/*     */ 
...
/*     */   public String get()
/*     */   {
/* 118 */     PlanType planType = (PlanType)this.planTypeService.get(this.typeId);
/*     */ 
