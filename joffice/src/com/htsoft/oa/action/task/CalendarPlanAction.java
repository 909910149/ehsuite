...
/*  79 */       filter.addFilter("Q_userId_L_EQ", ContextUtil.getCurrentUserId().toString());
/*     */     }
/*     */ 
...
/*     */ 
/*  88 */     Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().setDateFormat("yyyy-MM-dd HH:mm:ss").create();
...
/*     */ 
/* 105 */     filter.addFilter("Q_userId_L_EQ", ContextUtil.getCurrentUserId().toString());
...
/*     */   public String today()
/*     */   {
/* 117 */     PagingBean pb = new PagingBean(this.start.intValue(), this.limit.intValue());
/* 118 */     List<CalendarPlan> list = this.calendarPlanService.getTodayPlans(ContextUtil.getCurrentUserId(), pb);
/* 119 */     List planList = new ArrayList();
/*     */ 
/* 121 */     for (CalendarPlan plan : list) {
/* 122 */       planList.add(new PlanInfo(plan));
/*     */     }
/*     */ 
/* 125 */     Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss").create();
/*     */ 
/* 127 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
/* 128 */       .append(pb.getTotalItems()).append(",result:");
/* 129 */     Type type = new TypeToken() {  }
/* 129 */     .getType();
...
/*     */   public String get()
/*     */   {
/* 159 */     CalendarPlan calendarPlan = (CalendarPlan)this.calendarPlanService.get(this.planId);
/*     */ 
/* 161 */     Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss").create();
/*     */ 
...
/* 175 */       this.calendarPlan.setStatus(CalendarPlan.STATUS_UNFINISHED);
/*     */ 
...
/*     */     }
/*     */     else {
/* 185 */       CalendarPlan cp = (CalendarPlan)this.calendarPlanService.get(this.calendarPlan.getPlanId());
/*     */       try {
...
/*     */       try {
/* 214 */         Date reqDate = DateUtils.parseDate(monthday, new String[] { "MM/dd/yyyy" });
...
/*     */       try {
/* 238 */         Date reqDay = DateUtils.parseDate(day, new String[] { "MM/dd/yyyy" });
/*     */ 
...
/*     */       try {
/* 263 */         Date reqStartWeek = DateUtils.parseDate(startweek, new String[] { "MM/dd/yyyy" });
/* 264 */         Date reqEndWeek = DateUtils.parseDate(endweek, new String[] { "MM/dd/yyyy" });
...
/*     */       try
/*     */       {
/* 283 */         Date reqStartDate = DateUtils.parseDate(start, new String[] { "MM/dd/yyyy" });
/* 284 */         reqEndDate = DateUtils.parseDate(end, new String[] { "MM/dd/yyyy" });
/*     */ 
...
/*     */ 
/* 309 */     List<CalendarPlan> planList = this.calendarPlanService.getByPeriod(ContextUtil.getCurrentUserId(), startDate, endDate);
/*     */ 
/* 311 */     sb.append("{success:true,totalCount:").append(planList.size()).append(",records:[");
/*     */ 
...
/*     */       }
/*     */ 
/* 337 */       sb.append("subject:'").append(StringUtil.convertQuot(subject)).append("',");
/* 338 */       sb.append("description:'").append(StringUtil.convertQuot(plan.getContent())).append("',");
/* 339 */       sb.append("startdate:'").append(DateUtil.formatEnDate(startTime)).append("',");
/* 340 */       sb.append("enddate:'").append(DateUtil.formatEnDate(endTime)).append("',");
/* 341 */       sb.append("color:'").append(plan.getColor()).append("',");
/* 342 */       sb.append("parent:'0',");
/* 343 */       sb.append("priority:'").append(plan.getUrgent()).append("'},");
/*     */     }
/*     */ 
