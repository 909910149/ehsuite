...
/*  77 */     List list = this.dutyRegisterService.getAll(filter);
/*     */ 
/*  79 */     Type type = new TypeToken() {  }
/*  79 */     .getType();
...
/*     */ 
/* 102 */     List list = this.dutyRegisterService.getAll(filter);
/*     */ 
/* 104 */     Type type = new TypeToken() {  }
/* 104 */     .getType();
