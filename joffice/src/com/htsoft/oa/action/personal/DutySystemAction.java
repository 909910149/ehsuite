...
/*  54 */     List list = this.dutySystemService.getAll(filter);
/*     */ 
/*  56 */     Type type = new TypeToken() {  }
/*  56 */     .getType();
...
/*  73 */       this.dutySystem = ((DutySystem)this.dutySystemService.get(this.systemId));
/*     */     }
...
/*  79 */       String[] desc = this.dutySystem.getSystemDesc().split("[|]");
/*     */ 
/*  81 */       if ((desc != null) && (desc.length == 7)) {
/*  82 */         for (int i = 0; i < desc.length; i++) {
/*  83 */           buff.append("day").append(i).append(":'").append(desc[i]).append("',");
/*     */         }
/*     */       }
/*  86 */       if ((ids != null) && (ids.length == 7)) {
/*  87 */         for (int i = 0; i < ids.length; i++) {
/*  88 */           buff.append("dayId").append(i).append(":'").append(ids[i]).append("',");
/*     */         }
/*     */       }
/*     */ 
...
/*     */     }
/*     */     else {
/*  95 */       buff.append("day0:'',day1:'',day2:'',day3:'',day4:'',day5:'',day6:''")
/*  96 */         .append(",dayId0:'',dayId1:'',dayId2:'',dayId3:'',dayId4:'',dayId5:'',dayId6:''");
/*     */     }
/*  98 */     buff.append("}]}");
...
/*     */   public String get()
/*     */   {
/* 126 */     DutySystem dutySystem = (DutySystem)this.dutySystemService.get(this.systemId);
/*     */ 
...
/*     */ 
/* 142 */     List<DutySystem> dutySystemList = this.dutySystemService.getAll();
/* 143 */     sb.append("[");
/* 144 */     for (DutySystem dutySystem : dutySystemList) {
/* 145 */       sb.append("['").append(dutySystem.getSystemId()).append("','").append(dutySystem.getSystemName()).append("'],");
/*     */     }
...
/* 162 */     DutySystemSections[] dss = (DutySystemSections[])gson.fromJson(data, com.htsoft.oa.model.personal.DutySystemSections[].class);
/*     */ 
