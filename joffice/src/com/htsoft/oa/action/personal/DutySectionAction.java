...
/*     */ 
/*  52 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
/*  53 */       .append(filter.getPagingBean().getTotalItems()).append(",result:");
/*     */ 
/*  55 */     JSONSerializer serializer = JsonUtil.getJSONSerializer();
...
/*     */ 
/*  82 */     List<DutySection> dutySectionList = this.dutySectionService.getAll();
/*  83 */     sb.append("[");
/*  84 */     for (DutySection dutySection : dutySectionList) {
/*  85 */       sb.append("['").append(dutySection.getSectionId()).append("','").append(dutySection.getSectionName()).append("'],");
/*     */     }
...
/*     */   public String get()
/*     */   {
/* 101 */     DutySection dutySection = (DutySection)this.dutySectionService.get(this.sectionId);
/*     */ 
/* 103 */     JSONSerializer serializer = JsonUtil.getJSONSerializer();
/*     */ 
