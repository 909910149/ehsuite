...
import com.sun.net.ssl.internal.ssl.Provider;
 ...
 public class OutMailUserSetingAction extends BaseAction
 {
   ...
   public String list()
   {
     ...
     List list = this.outMailUserSetingService.getAll(filter);
   ...
   public String save()
   {
     ...
     if (this.outMailUserSeting.getId() == null) {
       ...
       OutMailUserSeting seting = (OutMailUserSeting)this.outMailUserSetingService.get(this.outMailUserSeting.getId());
       try {
         BeanUtil.copyNotNullProperties(seting, this.outMailUserSeting);
         this.outMailUserSetingService.save(seting);
         this.logger.debug(">>>" + seting);
       }
   ...
   protected boolean send(OutMailUserSeting os)
   {
     ...
     try
     {
       ...
       message.setFrom(
         new InternetAddress(os.getMailAddress(), 
   ...
   protected boolean fetch(OutMailUserSeting os)
   {
     ...
     try
     {
       ...
       URLName urln = new URLName("pop3", os.getPopHost(), 
         Integer.parseInt(os.getPopPort()), null, os.getMailAddress(), os
         .getMailPass());
