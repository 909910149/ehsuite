...
import com.htsoft.oa.service.communicate.PhoneGroupService;
 ...
 public class PhoneGroupAction extends BaseAction
 {
   ...
   public String list()
   {
     ...
     List<PhoneGroup> list = new ArrayList();
     if ((StringUtils.isNotEmpty(isPublic)) && ("true".equals(isPublic)))
       list = this.phoneGroupService.getPublicAll();
     else {
       list = this.phoneGroupService.getAll(ContextUtil.getCurrentUserId());
     }
   ...
   public String save()
   {
     Integer sn = Integer.valueOf(0);
     AppUser appUser = ContextUtil.getCurrentUser();
     if (PhoneGroup.IS_PUBLIC == this.phoneGroup.getIsPublic())
       sn = this.phoneGroupService.findPublicLastSn();
     else {
       sn = this.phoneGroupService.findLastSn(appUser.getUserId());
     }
