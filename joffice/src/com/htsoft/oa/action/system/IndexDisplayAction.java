...
/*  56 */     List list = this.indexDisplayService.getAll(filter);
/*     */ 
...
/*     */   public String get()
/*     */   {
/*  93 */     IndexDisplay indexDisplay = (IndexDisplay)this.indexDisplayService.get(this.indexId);
/*     */ 
...
/* 110 */     PanelItem[] panelItems = (PanelItem[])gson.fromJson(items, 
/* 111 */       com.htsoft.oa.model.system.PanelItem[].class);
