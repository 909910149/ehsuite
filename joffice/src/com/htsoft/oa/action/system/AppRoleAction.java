...
public class AppRoleAction extends BaseAction {
	...
	public String save() {
		...
		if ((StringUtils.isNotEmpty(isCopy)) && (IS_COPY.equals(isCopy))) {
			...
			this.appRole = ((AppRole) this.appRoleService.get(this.appRole
					.getRoleId()));
			...
			AppRole orgRole = (AppRole) this.appRoleService.get(new Long(
					this.appRole.getRoleId().longValue()));
			try {
