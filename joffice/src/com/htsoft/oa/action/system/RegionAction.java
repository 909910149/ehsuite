...
/*  56 */         buff.append("['" + province.getRegionId() + "','" + province.getRegionName() + "'],");
/*     */     }
/*     */     else
/*     */     {
...
/*     */       }
/*     */       else {
/*  66 */         setRegion((Region)this.regionService.get(this.regionId));
...
/*     */   public String tree()
/*     */   {
/*  81 */     StringBuffer buff = new StringBuffer("[{id:'0',text:'中国',expanded:true,children:[");
/*  82 */     List<Region> listProvince = this.regionService.getProvince();
/*  83 */     for (Region province : listProvince) {
/*  84 */       buff.append("{id:'" + province.getRegionId() + "',text:'" + province.getRegionName() + "',");
...
/* 108 */       buff1.append("{id:'" + city.getRegionId() + "',text:'" + city.getRegionName() + "',leaf:true},");
/*     */     }
/*     */ 
