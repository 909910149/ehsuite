...
<head>
	    ...
	    <script type="text/javascript">
	       ...
	       //alert('rights : '+userInfo.rights);
	       //alert('topModules : '+userInfo.topModules);
	...
	<body oncontextmenu="return false" onbeforeunload="return false;">
		...
		<div id="app-header">
			<div id="header-left">
				<img id ="CompanyLogo" src="<%=basePath+AppUtil.getCompanyLogo()%>" height="20" style="padding-left:6px;vertical-align: middle;"/>
			</div>
			<div id="header-main">
				<div id="header-info">
				</div>
			...
			<div id="header-right">
				<div id="setting">
				<img src="<%=basePath%>/images/icons/My_Account.png" style="vertical-align:middle;"/>&nbsp;
				<span style="color: blue;vertical-align:middle;">欢迎您,<security:authentication property="principal.fullname"/></span>
				<img src="<%=basePath%>/images/icons/MyDesk.png" style="vertical-align:middle;"/>&nbsp;<a href="#" onclick="App.clickTopTab('AppHome')"><span style="vertical-align:middle;">桌面</span></a>
				<c:if test="${IS_MANAGER ==true}">
					<img src="<%=basePath%>/images/icons/mydesktop.png" style="vertical-align:middle;"/>&nbsp;<a id="_Hazop_FeedFack_ATag" href="#" onclick="App.clickTopTab('SysConfigView');"><span style="vertical-align:middle;">设置</span></a>
				</c:if>   
				<img src="<%=basePath%>/images/icons/exit.png" style="vertical-align:middle;"/>&nbsp;<a href="#" onclick="App.Logout()"><span style="vertical-align:middle;">退出</span></a>
				    <!-- 
				    <a href="#" onclick="App.MyDesktopClick()" style="text-indent:25px;padding-left: 28px;" class="menu-index-company" >主页</a>
					<a href="#" onclick="App.clickTopTab('AppHome')" style="text-indent:25px; padding-left: 28px" class="menu-desktop">桌面</a>
					 -->
				</div>
				<!-- 全局搜索功能 暂时隐藏 -->
				<!-- 
