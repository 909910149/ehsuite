...
%>
  ...
  <div style="width:100%;height:50px;background-image:url('<%=basePath%>/images/f2.gif');padding-bottom:10px;">
  	<img alt="<%=AppUtil.getCompanyName()%>" src="<%=basePath+AppUtil.getCompanyLogo()%>" align="left"><h1 align="left" style="padding-top:10px;"> |流程设计 </h1>
  </div>
  <div id="flashContent">
...
<noscript>
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="bpmeditor">
        ...
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="<%=basePath%>/pages/bpm/bpmeditor.swf" width="100%" height="100%">
            <param name="quality" value="high" />
            <param name="bgcolor" value="#ffffff" />
            <param name="allowScriptAccess" value="sameDomain" />
            <param name="allowFullScreen" value="true" />
